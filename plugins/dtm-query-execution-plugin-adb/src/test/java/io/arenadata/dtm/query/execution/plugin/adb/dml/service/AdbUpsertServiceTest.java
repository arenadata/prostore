...
class AdbUpsertServiceTest {
    ...
    private AdbUpsertService adbUpsertService;

    @BeforeEach
    void setUp() {
        adbUpsertService = new AdbUpsertService(sqlDialect, executor, mppwTransferDataHandler);
    ...
    void shouldSuccessWhenUpsertWithColumns() {
        ...
        // act
        val result = adbUpsertService.execute(request);
