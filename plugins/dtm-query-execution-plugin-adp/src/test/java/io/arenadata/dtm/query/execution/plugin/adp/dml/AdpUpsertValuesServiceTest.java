...
class AdpUpsertValuesServiceTest {
    ...
    private AdpUpsertValuesService adpUpsertService;

    @BeforeEach
    void setUp() {
        adpUpsertService = new AdpUpsertValuesService(sqlDialect, executor, mppwTransferDataHandler);
    ...
    private UpsertValuesRequest getUpsertRequest(String s) {
